...
//	------------ CRUD PRODUTOS ------------
//
//	public String SelecionaProduto() { // Tentar criar um get Unitario
//		try {
...
//	}
	...
	public void salvarCompras(Compra compra ){
        try {
	...
	public List<Compra> getCompras(){
		...
		try {
			...
			while(this.resultset.next()) {
				...
				compra.setClienteId(resultset.getInt("cliente_id"));
				compra.setCodigoCompra(resultset.getInt("cod_compra"));
				compra.setDataCompra(resultset.getString("data_compra"));
				compras.add(compra);
			}
		}catch(Exception e){
			System.out.println("Erro: " + e.getMessage());
